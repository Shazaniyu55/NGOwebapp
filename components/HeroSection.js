    ...
    >
      <div className="md:w-2/3 lg:w-1/2 container px-5 md:px-16 mx-auto">
        <h1 className="capitalize flex flex-col gap-2 md:gap-5 text-3xl sm:text-4xl md:text-[3.2rem] 2xl:text-6xl font-bold">
          <p>
          YOUNG PEOPLES INITIATIVE FOR CREDIBLE LEADERSHIP
             </p>
        ...
        <button className="md:text-base text-sm hover:border-2 border-2 border-transparent font-semibold py-3 px-8 md:px-10 text-white bg-green-600 hover:border-green-600 hover:bg-transparent hover:text-green-600 rounded-full">
