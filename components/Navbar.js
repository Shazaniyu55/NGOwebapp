      ...
      <div className="container px-5 md:px-16 flex items-center justify-between mx-auto">
        <Link href={"/"}>
          <h2 className="text-3xl">
            <span className="text-green-600">Y</span>PICL.
          </h2>
        </Link>
          ...
          >
            ...
            {["home", "features", "pricing", "testimonial"].map((link) => (
              <li
                key={link}
                className={`${
                  selectedItem === link ? "text-green-600" : ""
                } capitalize border-b py-4 md:border-none md:py-0 hover:text-green-600`}
        ...
        <div className="flex items-center gap-2 sm:gap-4 md:gap-2 lg:gap-4">
          <button className="capitalize text-sm sm:text-base border-2 hover:border-2 font-semibold sm:py-3 py-2 px-3 sm:px-6 text-green-600 border-green-600 hover:border-green-600 hover:bg-green-600 hover:text-white rounded-full">
            {/* Login Page */}
